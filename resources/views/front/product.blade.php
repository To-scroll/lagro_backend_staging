                                        ...
                                        <div class="product-main no-arrow">
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('assets/front/images/product/category/1.jpg')}}" id="img-1"
                                                        data-zoom-image="{{asset('assets/front/images/product/category/1.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('assets/front/images/product/category/2.jpg')}}"
                                                        data-zoom-image="{{asset('assets/front/images/product/category/2.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('assets/front/images/product/category/3.jpg')}}"
                                                        data-zoom-image="{{asset('assets/front/images/product/category/3.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('assets/front/images/product/category/4.jpg')}}"
                                                        data-zoom-image="{{asset('assets/front/images/product/category/4.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('assets/front/images/product/category/5.jpg')}}"
                                                        data-zoom-image="{{asset('assets/front/images/product/category/5.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('assets/front/images/product/category/6.jpg')}}"
                                                        data-zoom-image="{{asset('assets/front/images/product/category/6.jpg')}}" class="
                            ...
                            <div class="tab-pane fade show active" id="description" role="tabpanel"
                                ...
                                <div class="product-description">
                                    ...
                                    <div class="banner-contain nav-desh">
                                        <img src="{{asset('assets/front/images/vegetable/banner/14.jpg')}}"
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-2.html">
                                            <img src="{{asset('assets/front/images/cake/product/11.png')}}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left.html">
                                            <img src="{{asset('assets/front/images/cake/product/7.png')}}" class="img-fluid" alt="">
                                        </a>
