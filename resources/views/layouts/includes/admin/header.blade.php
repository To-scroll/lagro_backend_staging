                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user"
                              src="{{ asset('public/logo/user-dummy-img.jpg') }}" alt="Header Avatar">
                              --}}
                            <img class="rounded-circle header-profile-user"
                                 src="{{ auth()->user()->user_type == 'staff' && auth()->user()->profile_image ? asset('public/images/staff/' . auth()->user()->profile_image) : asset('public/logo/user-dummy-img.jpg') }}"  alt="Header Avatar">
