...
@section('content')
    ...
    <form id="categoryCreateForm" method="POST" enctype="multipart/form-data" autocomplete="off" class="needs-validation"
        novalidate>
        @csrf
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="is_parent" name="is_parent" 
                                    data-choices data-choices-search-false>
                                    <option value="yes" selected {{ old('is_parent') == 'yes' ? 'selected' : '' }}>Yes
                                    </option>
